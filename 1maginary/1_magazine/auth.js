...
auth.onAuthStateChanged(user => {
    if (user) {
        ...
        // Hide the signup-box and login-background after successful login
        ...
        // Apply the styles to #center-container
...
function showSignupButton() {
    const logoutButton = document.querySelector('#signup-screen-button');
